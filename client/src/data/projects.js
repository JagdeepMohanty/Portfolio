export const projects = [
  ...
  },
  {
    ...
    description: "Full-stack web application built using Flask backend and MongoDB database, featuring dynamic data handling, API integration, and responsive frontend interface.",
    tech_stack: ["React", "HTML", "CSS", "JavaScript", "Python", "Flask", "MongoDB"],
  ...
  },
  {
    id: 3,
    title: "ButterBatter",
    description: "Responsive static website designed for ButterBatter brand with modern UI, optimized layout, and smooth user experience.",
